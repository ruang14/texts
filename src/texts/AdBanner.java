 ...
 * @author ruang
 */
public class AdBanner extends Applet implements Runnable{
    ...
    public Color C(String s1){
        ...
        try {
            ...
            System.out.println("Can't convert to integer, switching to default colors" + nfe);
            return null;
        }
        try {
            return new Color(i1, j1, k1);
        } catch (IllegalArgumentException iae) {
            System.out.println("Can't create new color, switching to default colors" + iae);
        }
        return null;
    }
